...
class BURST_OW_Base(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, 'data data/gt/demo/'),  # Location of GT   data/gt/mot_challenge/
            'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/demo/'),  # Trackers location  data/trackers/mot_challenge/
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            'TRACKERS_TO_EVAL': None,  # Filenames of trackers to eval (if None, all in folder)
            'CLASSES_TO_EVAL': ['car'],  # Classes to eval (if None, all classes)
    ...
    def __init__(self, config=None):
        ...
        self.valid_classes = ['car'] #[cls['name'] for cls in self.gt_data['categories'] if cls['id'] in seen_cats]
