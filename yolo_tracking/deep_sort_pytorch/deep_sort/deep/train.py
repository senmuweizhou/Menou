...
parser = argparse.ArgumentParser(description="Train on data")
parser.add_argument("--data-dir", default='E:/yolo_tracking-3.0/deep_sort_pytorch/deep_sort/deep/data', type=str)
